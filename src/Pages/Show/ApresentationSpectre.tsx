...
import Pspectre from '../../assets/Spectre2023.jpg'
import SpectreTraz from '../../assets/spectreTraz.jpg'
...
const ApresentationSpectre = () => {
  ...
  return (
    ...
    >
      ...
      <ScrollContainer>
        <ScrollPage >
          <Animator animation={batch(Sticky(), Fade(0), MoveOut(0, -700))}>
        ...
        <ScrollPage >
          ...
          <Animator animation={batch(Sticky(), Fade(), MoveOut(0, -700))}>
            <ImgSpectre>
              <img src={SpectreTraz} alt='trazeira'/>
            </ImgSpectre>
          </Animator>
